...
Window::Window () : QMainWindow (NULL) {
    QString name = "/Users/rmoutard/Pictures/RenduHD.png";
    rayImage = QImage(name);
    try {
        viewer = new GLViewer;
...
/**
 * @brief Window::initControlWidget
 * Create the Widget with all the buttons.
 * - Button for the wireframe
 * Section RayTracing
 * - Button for rendering
 * - Button for save.
 * Section Options
