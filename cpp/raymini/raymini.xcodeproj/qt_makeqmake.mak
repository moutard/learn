...
QMAKE    = /usr/bin/qmake
raymini.xcodeproj/project.pbxproj: raymini.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o raymini.xcodeproj/project.pbxproj raymini.pro
